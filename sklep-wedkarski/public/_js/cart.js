...
function updateCartValue() {
  ...
  document.getElementById('cart_value').innerHTML = "<i class=\"fas fa-shopping-cart\"></i> (".concat(cart.totalValue, "z\u0142)");
}
function showCartContent() {
  ...
  if (cart.itemsInCart.length == 0) {
    ...
    for (var i = 0; i < cart.itemsInCart.length; i++) {
      html += "\n            <tr>\n                <td>".concat(cart.itemsInCart[i].item.name, "</td>\n                <td>").concat(cart.itemsInCart[i].quantity, "</td>\n                <td>").concat(cart.itemsInCart[i].totalPrice, "z\u0142</td>\n                <td>\n                <div class=\"item_edit_buttons\">\n                    <button class=\"edit_cart\" onclick=\"editItem(").concat(i, ")\">Edytuj</button>\n                    <button class=\"remove_item\" onclick=\"removeItem(").concat(i, ")\">Usu\u0144</button>\n                </div>\n            </td>\n            </tr>\n            ");
    }
  }
  html += '</tbody></table>';
...
function editItem(itemId) {
  ...
  for (var i = 0; i < cart.itemsInCart.length; i++) {
    if (i == itemId) {
      html += "\n        <tr>\n            <td>".concat(cart.itemsInCart[i].item.name, "</td>\n            <td><input id=\"updated_quantity\" type=\"number\" min=\"1\" max=\"10\" value=\"").concat(cart.itemsInCart[i].quantity, "\"></td>\n            <td>").concat(cart.itemsInCart[i].totalPrice, "z\u0142</td>\n            <td>\n                <div class=\"item_edit_buttons\">\n                    <button class=\"edit_cart\" onclick=\"saveUpdatedItem(").concat(itemId, ")\">Zapisz</button>\n                </div>\n            </td>\n        </tr>\n        ");
    } else {
      html += "\n        <tr>\n            <td>".concat(cart.itemsInCart[i].item.name, "</td>\n            <td>").concat(cart.itemsInCart[i].quantity, "</td>\n            <td>").concat(cart.itemsInCart[i].totalPrice, "z\u0142</td>\n            <td></td>\n        </tr>\n        ");
    }
  }
